...
BASELINE = {
    ...
    "core/engine/entry_exec.py::set_leverage": 1,
    "core/engine/entry_exec.py::transfer": 1,
    "core/engine/monitors.py::create_order": 7,
    "core/engine/monitors.py::cancel_all_orders": 2,
    "core/engine/monitors.py::transfer": 1,
    "core/capital_allocator.py::transfer": 2,
    "core/order_mgmt/closing.py::cancel_all_orders": 1,
    "core/order_mgmt/closing.py::create_order": 3,
    "core/order_mgmt/entry.py::set_leverage": 1,
    "core/order_mgmt/funds.py::transfer": 1,
    "core/order_mgmt/protection.py::cancel_all_orders": 2,
    "core/order_mgmt/protection.py::create_order": 3,
